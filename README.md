...
> LYStack 不是又一个前端框架，也不是套一层 UI 的后台模板。市面上不缺框架，真正稀缺的是一套能解释“企业项目为什么会变复杂、复杂度应该被放在哪里、边界应该如何长期维护”的架构思想。
>
> 如果你愿意耐心看完它，不只是拿到一份代码，而是会开始从更高一层理解前端项目：从写功能，走向组织项目；从堆文件，走向设计边界；从跟着工具跑，走向让工具服务于你的工程体系。
